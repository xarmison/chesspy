...
class Yolo(object):
    ...
    def __init__(self, args: dict = {}, thresh: float = 0.3) -> None:
        """
            Initializes the YOLO detector.

            Args:
                args (dict, optional): A dictionary containing the paths to the YOLO configuration, weights, and metadata files. Defaults to {}.
        ...
        if args != {}:
            ...
            self.config_file = '/mnt/d/repos/chesspy/yolo/configs/yolov4_tiny_chess.cfg'
            self.weights_file = '/mnt/d/repos/chesspy/yolo/weights/yolov4_tiny_chess.weights'
            self.meta_file = '/mnt/d/repos/chesspy/yolo/data/chess_obj.data'
            self.thresh = thresh
